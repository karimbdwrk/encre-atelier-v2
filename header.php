	...
	<header id="masthead" class="site-header navbar-static-top <?php echo wp_bootstrap_starter_bg_class(); ?>" role="banner">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-10 nav-container">
                    <nav class="navbar">
                    ...
                    <?php echo do_shortcode( '[yith_wcwl_wishlist]' ); ?>
                        <a href="#" class="btn btn-wishlist">
                            ...
                            <svg class="wishlist-svg" xmlns="http://www.w3.org/2000/svg" width="50.57" height="45.315" viewBox="0 0 50.57 45.315">
                        ...
                        <button type="button" class="btn btn-recherche" data-toggle="modal" data-target="#searchModalHide">
                            <img src="https://encre-atelier.com/wp-content/uploads/2021/03/eye-close.svg" class="search-svg"/>
                        </button>
                        <a href="/checkout" class="btn btn-panier">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49.95 49.95" class="face-no-smile">
                                <g id="faceNoSmile" data-name="face-no-smile">
                                    ...
                                    <path class="mouth" d="M27.36,28c-5.62.36-10,4.83-11.36,10.09a1.51,1.51,0,0,0,2.9.8c1.05-4,4.33-7.74,8.7-7.9a8,8,0,0,1,5.32,1.84,12.55,12.55,0,0,1,1.64,1.62l.22.27.1.13c.09.13.19.26.28.4,1.05,1.61,3.65.11,2.59-1.51C35.5,30.29,31.57,27.72,27.36,28Z"/>
                ...
                <div class="col-1 col-md-6 d-none d-sm-block">
                    <!-- <nav class="navbar navbar-expand-xl p-0">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a href="" class="nav-link">Lab.</a></li>
