...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'fadeIn-1s', $product ); ?>>
	...
	<div class="summary entry-summary col-md-3">
		...
		<div class="face-atc">
			<svg id="faceSmile" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49.95 49.95" class="face">
				<g data-name="face-smile">
					...
					<path d="M26.59,39.93c5.61-.36,10-4.84,11.35-10.1a1.5,1.5,0,0,0-2.89-.8c-1.06,4-4.33,7.75-8.71,7.91A8,8,0,0,1,21,35.09a12,12,0,0,1-1.65-1.62l-.22-.27-.09-.12-.28-.41c-1.05-1.61-3.65-.1-2.59,1.52C18.45,37.63,22.37,40.2,26.59,39.93Z"/>
	...
	<div class="col-md-9">
		<button id="heartWishlist" class="btn">
...
<?php echo do_shortcode('[pods name="product" slug="' . $product->get_id() . '" template="Mini description produit"]'); ?>
